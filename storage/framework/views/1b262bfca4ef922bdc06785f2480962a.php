...
<div class="pt-vert">
  <div class="pt-head">
    <h3 class="pt-title"><?php echo e($title); ?></h3>
    <small class="pt-date">
  <?php echo e(now()->locale('sv')->translatedFormat('l d F Y')); ?>
  ...
  <ul class="pt-list">
    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      ?>
      <li class="pt-row <?php echo e($isNext ? 'is-next' : ''); ?>">
        <span class="pt-label"><?php echo e($r['label']); ?></span>
        <span class="pt-time"><?php echo e($timeText); ?></span>
      </li>
...
<?php /**PATH C:\Users\Admin\haninge\resources\views/partials/prayer-today.blade.php ENDPATH**/ ?>