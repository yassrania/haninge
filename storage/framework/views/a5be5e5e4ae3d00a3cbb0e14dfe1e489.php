...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom" style="line-height:1.2;">
  <div class="container">
    <a class="navbar-brand d-flex align-items-center gap-2 py-2" href="<?php echo e(route('home')); ?>">
      <span class="fw-semibold"><?php echo e(config('app.name', 'Haninge Islamiska Forum')); ?></span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        ...
        <?php $__currentLoopData = $menuTree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
            $href = $menuHref($item);
          ...
          <?php if($hasChildren): ?>
            <li class="nav-item dropdown" id="menu-item-<?php echo e($item->id); ?>">
              <a class="nav-link dropdown-toggle py-2 <?php echo e($active ? 'active' : ''); ?>"
                 href="<?php echo e($href); ?>"
                 id="dropdown-<?php echo e($item->id); ?>"
                 role="button"
              ...
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-<?php echo e($item->id); ?>">
                <?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php $childHref = $menuHref($child); ?>
                  <li>
                    <a class="dropdown-item <?php echo e($isActive($childHref) ? 'active' : ''); ?>"
                       href="<?php echo e($childHref); ?>"
                       <?php if(!empty($child->new_tab)): ?> target="_blank" rel="noopener" <?php endif; ?>>
          ...
          <?php else: ?>
            <li class="nav-item">
              <a class="nav-link py-2 <?php echo e($active ? 'active' : ''); ?>"
                 href="<?php echo e($href); ?>"
                 <?php if(!empty($item->new_tab)): ?> target="_blank" rel="noopener" <?php endif; ?>>
                <?php echo e($item->label); ?>
